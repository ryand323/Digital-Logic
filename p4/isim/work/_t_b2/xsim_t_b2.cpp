...
va_list vap)
{
    extern HSim__s6 * createworkM_t_b2(const char*);
    HSim__s6 *blk = createworkM_t_b2(label); 
    return blk;
}
...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        (*cfgvh).addVlogModule("work","TB2", (HSimInstFactoryPtr)IF0);
        ...
        HSim__s5 * topvl = 0;
        extern HSim__s6 * createworkM_t_b2(const char*);
        topvl = (HSim__s5*)createworkM_t_b2("TB2");
